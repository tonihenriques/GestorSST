jQuery(function ($) {
    ...
    function DeletarPergunta(IDPergunta, nome) {
            ...
            $.ajax({
                ...
                success: function (content) {
                    ...
                    if (content.resultado.Sucesso != null && content.resultado.Sucesso != "") {
                        $("#linha-" + IDPergunta).remove();
                    }
                }
            });
        };

        ExibirMensagemDeConfirmacaoSimples("Tem certeza que deseja excluir a '" + nome + "'?", "Exclusão de Pergunta", callback, "btn-danger");
